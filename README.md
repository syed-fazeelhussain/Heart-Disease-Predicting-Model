...
# Results of all the Logistic Regressions ---->

# Logistic Regression with No changes to Data
![LR No Changes](LR%20with%20no%20changed%20to%20data.png)

# Logistic Regression using Log method on Data
![LR Log Method](LR%20using%20log%20method%20on%20data.png)

# Logistic Regression omitting weight
